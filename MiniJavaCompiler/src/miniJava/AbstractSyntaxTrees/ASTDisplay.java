...
public class ASTDisplay implements Visitor<String,Object> {
    ...
    public Object visitForStmt(ForStmt stmt, String arg) {
    	show(arg, stmt);
    	stmt.varInitStmt.visit(this, indent(arg));
    	stmt.loopCondExpr.visit(this, indent(arg));
    	for (int i = 0; i < stmt.varIncrStmts.size(); i++) {
        	stmt.varIncrStmts.get(i).visit(this, indent(arg));
    	}
    	stmt.body.visit(this, indent(arg));
    	return null;
    }
    ...
    public Object visitIxIdRef(IxIdRef ir, String arg) {
    	show(arg, ir);
    	ir.id.visit(this, indent(arg));
    	ir.indexExpr.visit(this, indent(arg));
    	return null;
    }
    
    public Object visitQRef(QRef qr, String arg) {
    	show(arg, qr);
    ...
    public Object visitIxQRef(IxQRef qr, String arg) {
    	show(arg, qr);
    	qr.id.visit(this, indent(arg));
    	qr.ixExpr.visit(this,  indent(arg));
    	qr.ref.visit(this, indent(arg));
	    return null;
    }
    ...
    public Object visitNullLiteral(NullLiteral n, String arg) {
    	show(arg, quote(n.spelling) + " " + n.toString());
    	return null;
    }
}
